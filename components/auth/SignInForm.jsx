  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#3B3CFF] to-[#7B5CFF] flex items-center justify-center mb-4 shadow-lg shadow-indigo-500/30">
        ...
        <p className="text-lg font-semibold bg-gradient-to-r from-[#3B3CFF] to-[#FF6B6B] bg-clip-text text-transparent">
          AI Content Studio
        </p>
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <Link
              ...
              className="text-xs text-[#3B3CFF] hover:text-[#5B5CFF] font-medium transition-colors dark:text-indigo-400 dark:hover:text-indigo-300"
            >
              Forgot password?
            </Link>
          </div>
      ...
      {/* Footer links */}
      <p className="text-center text-sm mt-6 text-slate-400 dark:text-slate-500">
      ...
      <p className="text-center text-xs mt-8 text-slate-300 dark:text-slate-600">
